...
Reusable utilities are in the **"Shared Helpers"** section (line ~11110). Check here before writing new utility code:
...
Shared constants (defined near the top of the JS, line ~10514):
